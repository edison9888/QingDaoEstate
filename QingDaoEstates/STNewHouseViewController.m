...
- (void)viewDidLoad
{
    ...
    /*打折优惠按钮*/
    STBlockButton *discountBtn = [STBlockButton buttonWithType:UIButtonTypeCustom];
    [self.view addSubview:discountBtn];
    discountBtn.frame = CGRectMake(0, 0, self.view.bounds.size.width, 50);
    [discountBtn setBackgroundImage:[UIImage imageNamed:@"LP_mogu_loupanBg.png"] forState:UIControlStateNormal];
    /*看房车按钮*/
    STBlockButton *houseCarBtn = [STBlockButton buttonWithType:UIButtonTypeCustom];
    [self.view addSubview:houseCarBtn];
    houseCarBtn.frame = CGRectMake(0, 50, self.view.bounds.size.width, 50);
    [houseCarBtn setBackgroundImage:[UIImage imageNamed:@"LP_mogu_loupanBg.png"] forState:UIControlStateNormal];
    ...
    [header addSubview:discountBtn];
    [header addSubview:houseCarBtn];
}
